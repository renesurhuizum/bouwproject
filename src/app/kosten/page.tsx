...
// Kosten: uitgaven boeken, per categorie, met overzicht t.o.v. budget.
    ...
    <div className="h-full overflow-y-auto">
      <div className="mx-auto max-w-2xl space-y-4 p-4 pb-8">
        <header className="flex items-end justify-between px-1">
          <div>
            <h1 className="text-xl font-bold text-ink-900">Kosten</h1>
            <p className="text-sm text-ink-500">Bijgehouden uitgaven</p>
          </div>
          <div className="text-right">
            <div className="text-[11px] uppercase tracking-wider text-ink-500">Totaal</div>
            <div className="tabular text-2xl font-bold text-accent">{formatEuro(total)}</div>
          </div>
        </header>
