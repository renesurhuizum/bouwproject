...
export function Toolbar() {
  ...
  return (
    <div className="no-print pointer-events-none absolute inset-x-0 bottom-0 z-10 flex flex-col items-center gap-2 p-3 lg:pointer-events-auto lg:static lg:z-auto lg:min-h-0 lg:shrink-0 lg:max-h-[55%] lg:items-stretch lg:gap-1.5 lg:overflow-y-auto lg:border-t lg:border-line lg:p-2">
